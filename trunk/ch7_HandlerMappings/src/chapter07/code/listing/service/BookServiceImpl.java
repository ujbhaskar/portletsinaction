package chapter07.code.listing.service;
...
public class BookServiceImpl implements BookService {
	...
	public BookServiceImpl() {
		books.add(new Book("AspectJ in Action, Second Edition",
				"Ramnivas Laddad", Long.valueOf("1933988053")));
		books.add(new Book("ActiveMQ in Action",
				"Bruce Snyder, Dejan Bosanac, and Rob Davies", Long
						.valueOf("1933988940")));
		books.add(new Book("Hadoop in Action", "Chuck Lam", Long
