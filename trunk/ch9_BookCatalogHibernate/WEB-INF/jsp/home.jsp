...
<c:if test="${not empty books}">
	<table border="1">
		<tr bgcolor="#99CCFF">
			...
			<td valign="top"><b><fmt:message key="label.createdDate" /></b></td>
			<td valign="top"><b><fmt:message key="label.modifiedDate" /></b></td>
		...
		<c:forEach var="book" items="${books}">
			...
			<td valign="top"><fmt:formatDate value="${book.createdDate}" pattern="MM-dd-yyyy HH:mm:ss"/></td>
			<td valign="top"><fmt:formatDate value="${book.modifiedDate}" pattern="MM-dd-yyyy HH:mm:ss"/></td>
			<td valign="top"><a class="anchor" href="#"
				...
				<portlet:renderURL>
					...
					<portlet:param name="book_id" value="${book.id}" />
				</portlet:renderURL>
				'><fmt:message
			...
			<td align="center" valign="top" width="100px"><a class="anchor"
				href='
						<portlet:actionURL name="removeBookAction">
							<portlet:param name="isbnNumber" value="${book.id}" />
						</portlet:actionURL>					
					'
