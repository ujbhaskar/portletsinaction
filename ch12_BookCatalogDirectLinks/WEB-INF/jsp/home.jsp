...
<%
	...
	String tocBaseUrl = request.getContextPath() + "/toc/";
%>
<table align="right">
	<tr>
...
<c:if test="${not empty books}">
	<table border="1">
		...
		<c:forEach var="book" items="${books}">
			...
			<td valign="top"><a class="anchor" href='<%= tocBaseUrl%><c:out value="${book.isbnNumber}" /><c:out value="${book.tocFileExtension}" />'><b>&nbsp;&nbsp;<fmt:message
