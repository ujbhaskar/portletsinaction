...
public class BookCatalogPortlet extends GenericPortlet {
	...
	public void removeBook(ActionRequest request, ActionResponse response)
		...
		logger.info("recentBookIsbn public render parameter " + ((String[])request.getPublicParameterMap().get("recentBookIsbn"))[0]);
		bookService
	...
	public void addBook(ActionRequest request, ActionResponse response)
		...
		if (errorMap.isEmpty()) {
			...
			//-- about the saved book in the render parameter
			response.setRenderParameter("recentBookIsbn", isbnNumber);
		} else {
			logger
